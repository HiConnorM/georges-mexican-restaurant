export default function AboutUs() {
  return (
    <section id="About-us" className="section without-bottom-spacing">
      <div className="w-layout-blockcontainer base-container w-container">
        <div className="about-us-section-wrapper">
          ...
          <div
            data-w-id="36997ebb-6f0e-7c1e-ac4a-21ad4bc92329"
            style={{ opacity: 0 }}
            className="text-content-about-us"
          >
            <h6 className="heading-6">bienvenidos amigos </h6>
            <div className="center-heading-about-us">
              eat well.
              <br />
              be happy.
              <br />
            ...
            <p className="paragraph-about">
              Whether you&#39;re here for a casual lunch or a special dinner, our commitment to
              exceptional service and unforgettable flavors ensures a memorable experience every
              time you visit.
            </p>
          </div>
